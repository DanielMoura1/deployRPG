...
exports.Prisma.DeckScalarFieldEnum = makeEnum({
  id: 'id',
  idUser: 'idUser',
  vida: 'vida',
  maxVida: 'maxVida',
...
exports.Prisma.InimigoScalarFieldEnum = makeEnum({
  id: 'id',
  nome: 'nome',
  foto: 'foto',
  fase: 'fase',
...
exports.Prisma.InimigosScalarFieldEnum = makeEnum({
  id: 'id',
  poder: 'poder',
  nome: 'nome',
  foto: 'foto',
...
exports.Prisma.OuroCardScalarFieldEnum = makeEnum({
  id: 'id',
  ouro: 'ouro',
  cardId: 'cardId'
});

exports.Prisma.OuroScalarFieldEnum = makeEnum({
  id: 'id',
  ouro: 'ouro',
  usuarioId: 'usuarioId'
});
...
exports.Prisma.VitoriasScalarFieldEnum = makeEnum({
  id: 'id',
  vitorias: 'vitorias',
  usuarioId: 'usuarioId'
});
