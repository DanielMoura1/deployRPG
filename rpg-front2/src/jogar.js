...
export default function JOGAR(props){
    ...
    async function ok(){
        if(okatk){
            ...
            const promise = axios.post(
                'http://54.159.2.218/api/inimigos',
                {golpe},{headers: {
                    authorization : token
                }}
            );
    ...
    useEffect(() => {
        async function getpg1(){
         try{
            const promessa=await axios.get('http://54.159.2.218/api/criarUser',{headers: {
                authorization : token
             }})
        ...
        async function getpg2(){
            try{//https://daniel-moura-rpg.herokuapp.com/inimigos
               const promessa=await axios.get('http://54.159.2.218/api/inimigos',{headers: {
                   authorization : token
                }})
           ...
           async function getpg3(){
            try{//https://daniel-moura-rpg.herokuapp.com/inimigos
               const promessa=await axios.get('http://54.159.2.218/api/perfil',{headers: {
                   authorization : token
                }})
